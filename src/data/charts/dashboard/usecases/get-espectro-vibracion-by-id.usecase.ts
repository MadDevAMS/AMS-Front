...
export class GetEspectroVibracionByIdUsecase implements UseCase<string, IApiResponse<any>> {
  constructor(private chartDashboardRepository: ChartDashboardRepository){ }

  execute(params: string): Observable<IApiResponse<any>> {
    return this.chartDashboardRepository.getEspectroVibracionById(params)
  }
}